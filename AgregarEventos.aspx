<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgregarEventos.aspx.cs" Inherits="ProyectoTPS.AgregarEventos" %>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
                                        <asp:TextBox ID="TxtNombreSolicitante" CssClass="form-control" placeholder="Descripcion Evento" runat="server"></asp:TextBox>
									</div>
									<div class="form-group">
                                         <asp:TextBox ID="TxtFechaSolicitud" cols="30" rows="7" CssClass="form-control" placeholder="Fecha Evento 01-02-2019" runat="server"></asp:TextBox>
									</div>
									<div class="form-group">
                                    ...
                                    <div class="form-group">
                                  <asp:DropDownList ID="comboxMantencionEvento" runat="server" DataSourceID="SqlDataSource1" DataTextField="TituloMantencion" DataValueField="TituloMantencion" AutoPostBack="True">
                                            <asp:ListItem Selected="True">Seleccionar Mantención</asp:ListItem>
                                            </asp:DropDownList>
                                            <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:ConnectionString %>' SelectCommand="SELECT [TituloMantencion] FROM [Mantencion] ORDER BY [FechaRealizacionMantencion]"></asp:SqlDataSource>
                                        </div>
                            <div class="form-group">
                                  <asp:DropDownList ID="DropDownList1" runat="server" >
                                                <asp:ListItem>Seleccionar Nuevo Estado </asp:ListItem>
									...
									<div class="form-group">
                                        <asp:Button ID="btnEvento" runat="server" CssClass="btn btn-primary btn-md" Text="Modificar Mantención" OnClick="btnEvento_Click" />
